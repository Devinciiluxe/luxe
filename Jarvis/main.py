...
def main():
    ...
    def runner():
        ...
        from core.hermes_session import HermesSession
        ...
        api_key = cfg.get("nous_api_key", "").strip()
        if not api_key:
            ui.write_log(
                "ERR: 'nous_api_key' is missing in config/api_keys.json. "
                "Get your key at dashboard.nousresearch.com then add it to the config."
            )
        ...
        session = HermesSession(
            ...
            model=cfg.get("nous_model", "upstage/solar-pro4"),
